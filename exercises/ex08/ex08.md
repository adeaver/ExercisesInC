...
GLib started as part of the GTK+ project, which is a project for creating user interfaces. It is currently maintained by the GNOME project, which is part of the GNU project. GLib contains advanced data structures as well as general functionality delivered in a portable way, as it was the non-GUI parts of the original GUI project.

*  What are the most important pros and cons of using GLib, as opposed
to another library, or just using core C features?

The most important pro is that it's portable. Generally, GLib functions add portability to the C functions. However, it also requires the users of a program to have specific libraries installed. 
