...
It no longer appears in the assembly language file.
...
It keeps the 5 in the file. It doesn't change much between compiling with and without optimization.
...
It gets rid of x and y and just prints `6` when you optimize it.

What conclusions can you draw about how optimization works?

It looks to minimize variable declarations. Optimization can essentially run your program in a sense.
